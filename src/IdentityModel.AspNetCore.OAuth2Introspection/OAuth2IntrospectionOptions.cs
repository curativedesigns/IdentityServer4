...
namespace IdentityModel.AspNetCore.OAuth2Introspection
{
    ...
    {
        internal object AssertionUpdateLockObj = new();
        ...
        /// <summary>
        ///     Specifies whether the outcome of the token validation should be cached. This reduces the load on the introspection
        ///     endpoint at the STS
        /// </summary>
        ...
        /// </summary>
        public Func<OAuth2IntrospectionOptions, string, string> CacheKeyGenerator { get; set; } =
            CacheUtils.CacheKeyFromToken();
