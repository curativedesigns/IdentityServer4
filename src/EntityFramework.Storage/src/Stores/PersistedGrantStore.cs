...
namespace IdentityServer4.EntityFramework.Stores
{
    ...
    public class PersistedGrantStore : IPersistedGrantStore
    {
        ...
        public async Task<IEnumerable<PersistedGrant>> GetAllAsync(PersistedGrantFilter filter)
        {
            ...
            Logger.LogDebug("{persistedGrantCount} persisted grants found for {@filter}", persistedGrants.Length,
                filter);
        ...
        public async Task RemoveAllAsync(PersistedGrantFilter filter)
        {
            ...
            Logger.LogDebug("removing {persistedGrantCount} persisted grants from database for {@filter}",
        ...
        private IQueryable<Entities.PersistedGrant> Filter(IQueryable<Entities.PersistedGrant> query,
