...
public class LocalApiAuthenticationHandler : AuthenticationHandler<LocalApiAuthenticationOptions>
{
    ...
    /// <inheritdoc />
    public LocalApiAuthenticationHandler(IOptionsMonitor<LocalApiAuthenticationOptions> options, ILoggerFactory logger,
        UrlEncoder encoder, ISystemClock clock, ITokenValidator tokenValidator)
    ...
    {
        return Task.FromResult<object>(new LocalApiAuthenticationEvents());
    }
    ...
    protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        var authenticationTicket =
            new AuthenticationTicket(claimsTransformationContext.Principal, authenticationProperties, Scheme.Name);
