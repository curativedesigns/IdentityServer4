...
{
    /// <summary>
    ///     Sets the cookie authentication scheme configured by the host used for interactive users. If not set, the scheme
    ///     will inferred from the host's default authentication scheme.
    ...
    /// <summary>
    ///     If set, will require frame-src CSP headers being emitting on the end session callback endpoint which renders
    ///     iframes to clients for front-channel signout notification.
    /// </summary>
