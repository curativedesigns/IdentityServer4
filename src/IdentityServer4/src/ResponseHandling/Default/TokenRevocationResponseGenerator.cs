...
public class TokenRevocationResponseGenerator : ITokenRevocationResponseGenerator
{
    ...
    public TokenRevocationResponseGenerator(IReferenceTokenStore referenceTokenStore,
        IRefreshTokenStore refreshTokenStore, ILogger<TokenRevocationResponseGenerator> logger)
    {
    ...
    /// <returns></returns>
    public virtual async Task<TokenRevocationResponse> ProcessAsync(
        TokenRevocationRequestValidationResult validationResult)
    {
        ...
        if (token != null)
        {
            ...
            else
            {
                Logger.LogWarning(
                    ...
                    validationResult.Client.ClientId, token.ClientId);
            }
