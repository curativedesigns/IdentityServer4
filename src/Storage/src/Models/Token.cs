...
namespace IdentityServer4.Models
{
    ...
    public class Token
    {
        ...
        public string SubjectId =>
            Claims.Where(x => x.Type == JwtClaimTypes.Subject).Select(x => x.Value).SingleOrDefault();
        ...
        public string SessionId =>
            Claims.Where(x => x.Type == JwtClaimTypes.SessionId).Select(x => x.Value).SingleOrDefault();
